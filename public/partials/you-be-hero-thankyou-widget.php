...
if ( isset( $youbehero_data['status'] ) && $youbehero_data['status'] == 'active' && ! empty( $youbehero_data ) ) {
    ...
    $ybhd_check_w_active = $youbehero_data['widget_configurations']['confirmation_page']['confirmation_page']['active'] ?? false;

    if ( $ybhd_check_w_active ) {
        $ybhd_selected_cause_info = $this->youbehero_get_ordered_cause( $youbehero_data['selected_causes'], $donation_org_id );
        if ( ! empty( $ybhd_selected_cause_info ) ) {

            $ybhd_social_links     = $ybhd_selected_cause_info['social_links'];
            $ybhd_org_logo         = $ybhd_selected_cause_info['image'] ?? esc_url( YBHD_PLUGIN_URL ) . 'public/img/humanity_fund.png';
            $ybhd_background_color = $youbehero_data['widget_configurations']['confirmation_page']['confirmation_page']['background_color'] ?? '#ffffff';
            $ybhd_text_color       = $youbehero_data['widget_configurations']['confirmation_page']['confirmation_page']['text_color'] ?? '#000000';
            $ybhd_plaisio_color    = $youbehero_data['widget_configurations']['confirmation_page']['confirmation_page']['plaisio_color'] ?? '#cccccc';
            $ybhd_border           = $youbehero_data['widget_configurations']['confirmation_page']['confirmation_page']['border'] ?? '';
            $ybhd_border_color     = $youbehero_data['widget_configurations']['confirmation_page']['confirmation_page']['border_color'] ?? '';
            $ybhd_border_radius    = $youbehero_data['widget_configurations']['confirmation_page']['confirmation_page']['border_radius'] ?? '';
            $ybhd_widget_margin    = $youbehero_data['widget_configurations']['confirmation_page']['confirmation_page']['margin'] ?? '';
            $ybhd_widget_padding   = $youbehero_data['widget_configurations']['confirmation_page']['confirmation_page']['padding'] ?? '';

    ?>

            <section class="youbehero-thankyou-widget">
                <div class="youbehero-tk-card" style="border: <?php echo esc_attr( $ybhd_border . 'px solid' ); ?>; border-radius: <?php echo esc_attr( $this->youbehero_get_mpb_value( 'b_radius', $ybhd_border_radius ) ); ?>; border-color: <?php echo esc_attr( $ybhd_border_color ); ?>; margin: <?php echo esc_attr( $this->youbehero_get_mpb_value( 'margin', $ybhd_widget_margin ) ); ?>; padding: <?php echo esc_attr( $this->youbehero_get_mpb_value( 'padding', $ybhd_widget_padding ) ); ?>; background: <?php echo esc_attr( $ybhd_background_color ); ?>; color: <?php echo esc_attr( $ybhd_text_color ); ?>;">
                <!-- Top Icon -->
                    <?php if ( ! empty( $ybhd_selected_cause_info['url'] ) ) { ?>
                        <a href="<?php echo esc_url( $ybhd_selected_cause_info['url'] ); ?>" target="_blank" rel="noreferrer">
                            <img class="youbehero-tk-icon" src="<?php echo esc_url( $ybhd_org_logo ); ?>" alt="icon">
                        </a>
                    <?php } else { ?>
                    <img class="youbehero-tk-icon" src="<?php echo esc_url( $ybhd_org_logo ); ?>" alt="icon">
                    <?php } ?>
                    ...
                    <!-- Title -->
                    <h3 style="color: <?php echo esc_attr( $ybhd_text_color ); ?>;"><?php echo esc_html__( 'Your donation has been recorded.' , 'youbehero' );  ?></h3>
                    <p class="tk-p1" style="color: <?php echo esc_attr( $ybhd_text_color ); ?>;"><?php echo esc_html__( 'Thank you very much for your support and generosity.', 'youbehero' ); ?></p>
                    ...
                    <div class="youbehero-tk-org-box" style="background: <?php echo esc_attr( $ybhd_plaisio_color ); ?>;">
                        ...
                        <div class="youbehero-tk-social-icons">
                            <?php if ( ! empty( $ybhd_selected_cause_info['url'] ) ) { ?>
                                <a href="<?php echo esc_url( $ybhd_selected_cause_info['url'] ); ?>" target="_blank">
                                    <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect x="0.498535" y="0.606262" width="15" height="15" rx="1.5" fill="<?php echo esc_attr( $ybhd_text_color ); ?>"/>
                                        <rect x="0.498535" y="0.606262" width="15" height="15" rx="1.5" stroke="<?php echo esc_attr( $ybhd_text_color ); ?>"/>
                    ...
                    <div class="youbehero-tk-footer" style="color: <?php echo esc_attr( $ybhd_text_color ); ?>;">
                        ...
                        <a class="youbehero-tk-footer-logo" href="https://youbehero.com/gr/diafaneia" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="92" height="16" viewBox="0 0 92 16" fill="none">
                                <path d="M30.1395 3.08781H30.0569C29.3031 3.08781 28.692 3.69893 28.692 4.45278C28.692 5.20663 29.3031 5.81775 30.0569 5.81775H30.1395C30.8934 5.81775 31.5045 5.20663 31.5045 4.45278C31.5045 3.69893 30.8934 3.08781 30.1395 3.08781Z" fill="#212121"/>
                                <path d="M23.1352 3.08785H23.0526C22.2987 3.08785 21.6876 3.69897 21.6876 4.45282C21.6876 5.20667 22.2987 5.81778 23.0526 5.81778H23.1352C23.8891 5.81778 24.5002 5.20667 24.5002 4.45282C24.5002 3.69897 23.8891 3.08785 23.1352 3.08785Z" fill="#212121"/>
                                <path d="M28.692 7.16933V7.54775C28.692 9.22355 27.7995 10.2236 26.5825 10.2236C25.2033 10.2236 24.5002 9.00732 24.5002 7.54775V7.16933H21.6876V7.73696C21.6876 11.0345 23.6618 12.8454 26.5825 12.8454C29.7467 12.8454 31.5045 10.8183 31.5045 7.73696V7.16933H28.692Z" fill="#212121"/>
                                <path d="M7.73891 3.08781L5.69774 8.62161L3.62973 3.08781H0.782837L4.2743 12.5007L2.9583 16H5.83202L10.6127 3.08781H7.73891Z" fill="#212121"/>
                                <path d="M15.5276 3.08781C12.8122 3.08781 10.6127 5.28612 10.6127 8.00007C10.6127 10.714 12.8122 12.9123 15.5276 12.9123C18.243 12.9123 20.4425 10.714 20.4425 8.00007C20.4425 5.28612 18.243 3.08781 15.5276 3.08781ZM15.5276 10.2255C14.3057 10.2255 13.3281 9.22134 13.3281 8.0272C13.3281 6.83306 14.3328 5.82891 15.5276 5.82891C16.7224 5.82891 17.7271 6.83306 17.7271 8.0272C17.7271 9.22134 16.7495 10.2255 15.5276 10.2255Z" fill="#212121"/>
                                <path d="M86.3023 3.08781C83.5869 3.08781 81.3874 5.28612 81.3874 8.00007C81.3874 10.714 83.5869 12.9123 86.3023 12.9123C89.0177 12.9123 91.2172 10.714 91.2172 8.00007C91.2172 5.28612 89.0177 3.08781 86.3023 3.08781ZM86.3023 10.2255C85.0803 10.2255 84.1028 9.22134 84.1028 8.0272C84.1028 6.83306 85.1075 5.82891 86.3023 5.82891C87.4971 5.82891 88.5018 6.83306 88.5018 8.0272C88.5018 9.22134 87.5242 10.2255 86.3023 10.2255Z" fill="#212121"/>
